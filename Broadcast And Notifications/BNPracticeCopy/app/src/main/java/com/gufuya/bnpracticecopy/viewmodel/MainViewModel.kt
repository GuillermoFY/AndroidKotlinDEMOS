package com.gufuya.bnpracticecopy.viewmodel
...
import com.gufuya.bnpracticecopy.MainActivity
import com.gufuya.bnpracticecopy.R
import com.gufuya.bnpracticecopy.receiver.Receiver
import com.gufuya.bnpracticecopy.model.Message
...
class MainViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun sBroadcast(msg: String,context: Context){
        ...
        Intent().also { intent ->
            ...
            intent.putExtra("dataCopy", message)
    ...
    */
    ...
    private fun createNotification(msg: String?) {
        ...
        with(builder) {
            ...
            setContentTitle("Original Application")
